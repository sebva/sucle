...
if(isset($_POST['social_id'], $_POST['type_social'], $_POST['token'], $_POST['device_id'], $_POST['type_mobile'], $_POST['os_version'])
    ...
    echo (new DataBase())->logIn($_POST['social_id'], $_POST['type_social'], $_POST['token'], new Device(array('device_id' => $_POST['device_id'], 'type' => $_POST['type_mobile'], 'os_version' => $_POST['os_version'])));
else
